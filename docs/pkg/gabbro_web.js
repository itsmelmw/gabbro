...
*/
__exports.run_gameboy = function(rom, lcd_buffer, joypad_buffer) {
    wasm.run_gameboy(addHeapObject(rom), addHeapObject(lcd_buffer), addHeapObject(joypad_buffer));
};
...
* @param {Uint8Array} lcd_buffer
*/
__exports.update_lcd_canvas = function(canvas, lcd_buffer) {
    wasm.update_lcd_canvas(addHeapObject(canvas), addHeapObject(lcd_buffer));
};
...
* @param {Uint8Array} joypad_buffer
*/
__exports.update_joypad_buffer = function(key_code, pressed, joypad_buffer) {
    const ptr0 = passStringToWasm0(key_code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.update_joypad_buffer(ptr0, len0, pressed, addHeapObject(joypad_buffer));
};
...
* @returns {number}
*/
__exports.lcd_buffer_size = function() {
    const ret = wasm.lcd_buffer_size();
    return ret >>> 0;
};
...
* @returns {number}
*/
__exports.joypad_buffer_size = function() {
    const ret = wasm.joypad_buffer_size();
    return ret >>> 0;
};
...
function getImports() {
    ...
    imports.wbg.__wbg_postMessage_b6bc7e7296a23107 = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_new_ebc2634cf6af6cf0 = function(arg0) {
    ...
    imports.wbg.__wbg_set_d1017675d13cf3d5 = function(arg0, arg1, arg2) {
        getObject(arg0).set(getObject(arg1), arg2 >>> 0);
    };
    imports.wbg.__wbg_length_065287541268ea52 = function(arg0) {
        const ret = getObject(arg0).length;
        return ret;
    };
    ...
    imports.wbg.__wbg_wait_f8d00ca16297eb23 = function() { return handleError(function (arg0, arg1, arg2, arg3) {
        const ret = Atomics.wait(getObject(arg0), arg1 >>> 0, arg2, arg3);
        return addHeapObject(ret);
    }, arguments) };
